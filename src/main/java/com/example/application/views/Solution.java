...
@PageTitle("Solution")
@Route(value = "solution")
public class Solution extends VerticalLayout {
    ...
    public Solution() {
        ...
        textStyle.setFont("bold 16px Arial");
        textStyle.setTextBaseline(TextStyle.TextBaseline.MIDDLE);
        textStyle.setFill("#831843");
        textStyle.setStroke("white", 3);
        textStyle.setOffset(0, -50);

        addressMarker = new MarkerFeature();
        addressMarker.setText("My address");
        addressMarker.setTextStyle(textStyle);
        ...
        map.addFeatureDropListener(event -> {
            ...
            try {
                String address = Geolocation.lookupAddress(coordinate);
